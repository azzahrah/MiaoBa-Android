...
jint Java_cn_nodemedia_library_audio_AudioCodec_audio_1codec_1init(JNIEnv *env,
...
jint Java_cn_nodemedia_library_audio_AudioCodec_audio_1encode(JNIEnv *env,
...
jint Java_cn_nodemedia_library_audio_AudioCodec_audio_1decode(JNIEnv *env,
