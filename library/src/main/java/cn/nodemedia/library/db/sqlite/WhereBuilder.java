            ...
            if ("IN".equalsIgnoreCase(op)) {
                ...
                if (items != null) {
                    ...
                    for (Object item : items) {
                        Object itemColValue = cn.nodemedia.library.db.table.ColumnUtils.convert2DbValueIfNeeded(item);
                ...
                if (items != null) {
                    ...
                    Object startColValue = cn.nodemedia.library.db.table.ColumnUtils.convert2DbValueIfNeeded(start);
                    Object endColValue = cn.nodemedia.library.db.table.ColumnUtils.convert2DbValueIfNeeded(end);
                ...
                value = cn.nodemedia.library.db.table.ColumnUtils.convert2DbValueIfNeeded(value);
