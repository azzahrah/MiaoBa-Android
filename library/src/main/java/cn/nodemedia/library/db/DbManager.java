...
public interface DbManager extends Closeable {
    ...
    int delete(Class<?> entityType, cn.nodemedia.library.db.sqlite.WhereBuilder whereBuilder) throws DbException;

    // update

    void update(Object entity, String... updateColumnNames) throws DbException;

    int update(Class<?> entityType, cn.nodemedia.library.db.sqlite.WhereBuilder whereBuilder, KeyValue... nameValuePairs) throws DbException;
    ...
    cn.nodemedia.library.db.table.DbModel findDbModelFirst(cn.nodemedia.library.db.sqlite.SqlInfo sqlInfo) throws DbException;

    List<cn.nodemedia.library.db.table.DbModel> findDbModelAll(cn.nodemedia.library.db.sqlite.SqlInfo sqlInfo) throws DbException;
     ...
     * @throws DbException
     */
    <T> cn.nodemedia.library.db.table.TableEntity<T> getTable(Class<T> entityType) throws DbException;
    ...
    int executeUpdateDelete(cn.nodemedia.library.db.sqlite.SqlInfo sqlInfo) throws DbException;

    int executeUpdateDelete(String sql) throws DbException;

    void execNonQuery(cn.nodemedia.library.db.sqlite.SqlInfo sqlInfo) throws DbException;

    void execNonQuery(String sql) throws DbException;

    Cursor execQuery(cn.nodemedia.library.db.sqlite.SqlInfo sqlInfo) throws DbException;
    ...
    public interface TableCreateListener {
        void onTableCreated(DbManager db, cn.nodemedia.library.db.table.TableEntity<?> table);
    }

    public static class DaoConfig {

        private File dbDir;
        private String dbName = "simpleway.db";
