...
public final class ColumnUtils {
    ...
    public static Object convert2DbValueIfNeeded(final Object value) {
        ...
        if (value != null) {
            ...
            cn.nodemedia.library.db.converter.ColumnConverter converter = ColumnConverterFactory.getColumnConverter(valueType);
    ...
    static Method findGetMethod(Class<?> entityType, Field field) {
        ...
        if (getMethod == null) {
            ...
            try {
                ...
                //Log.d(entityType.getName() + "#" + methodName + " not exist");
            }
        }
