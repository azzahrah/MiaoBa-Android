...
public final class TableEntity<T> {
    ...
    private cn.nodemedia.library.db.table.ColumnEntity id;
    ...
    /*package*/ TableEntity(DbManager db, Class<T> entityType) throws Throwable {
        ...
        for (cn.nodemedia.library.db.table.ColumnEntity column : columnMap.values()) {
            if (column.isId()) {
                this.id = column;
                break;
            }
    ...
    public cn.nodemedia.library.db.table.ColumnEntity getId() {
        return id;
    }
