...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
    private int onColor = 0xFF2787DB;
    /**
     * 关闭颜色
     */
    private int offBorderColor = 0xFF979797;
    /**
     * 灰色带颜色
     */
    ...
    public void setup(AttributeSet attrs) {
        ...
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_lineWidth, borderWidth);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthSpecMode == MeasureSpec.AT_MOST || widthSpecMode == MeasureSpec.UNSPECIFIED) {
            widthMeasureSpec = MeasureSpec.makeMeasureSpec(ScreenUtils.dp2px(40), MeasureSpec.EXACTLY);
        }

        if (heightSpecMode == MeasureSpec.AT_MOST || heightSpecMode == MeasureSpec.UNSPECIFIED) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(ScreenUtils.dp2px(20), MeasureSpec.EXACTLY);
        }
