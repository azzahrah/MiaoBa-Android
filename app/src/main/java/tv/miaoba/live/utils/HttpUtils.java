...
public class HttpUtils {
     ...
     * @param params  参数
     */
    private static void putHttpToJson(String httpUrl, Map<String, Object> params, HttpCallback<?> asyncCallBack) {
        getInstance().getService().putHttpToJson(httpUrl, getParamsJson(params))
                .subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(asyncCallBack);
    }
     ...
     * @param params  参数
     */
    private static void delHttpToJson(String httpUrl, Map<String, Object> params, HttpCallback<?> asyncCallBack) {
        getInstance().getService().deleteHttpToJson(httpUrl, getParamsJson(params))
                .subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(asyncCallBack);
    }
     ...
     * @param nickname 昵称
     */
    public static void putUserInfo(int userid, String uname, String nickname, HttpCallback<UserInfo> asyncCallBack) {
        Map<String, Object> sortMap = new HashMap<>();
        sortMap.put("userid", userid);
        sortMap.put("uname", uname);
        sortMap.put("nickname", nickname);
        putHttpToJson(Constants.HTTP_USERINFO_PUT, sortMap, asyncCallBack);
    }
     ...
     * @param title    标题
     */
    public static void publishLive(int userid, String location, String title, HttpCallback<Object> asyncCallBack) {
        Map<String, Object> sortMap = new HashMap<>();
        sortMap.put("userid", userid);
        sortMap.put("location", location);
        sortMap.put("title", title);
        postHttpToJson(Constants.HTTP_LIVE_POST, sortMap, asyncCallBack);
    }
     ...
     * @param userid 登陆用户ID
     */
    public static void publishLiveEnd(int id, int userid, HttpCallback<Object> asyncCallBack) {
        Map<String, Object> sortMap = new HashMap<>();
        sortMap.put("id", id);
        sortMap.put("userid", userid);
        delHttpToJson(Constants.HTTP_LIVE_DEL, sortMap, asyncCallBack);
    }
